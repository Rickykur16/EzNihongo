 ...
 * Storage: localStorage (key: eznihongo_vocab_fsrs_v1)
 *
 * Adapted from the legacy Nihonggo learn app. Original algorithm + public API
 * intact; storage key re-namespaced so vocab flashcards don't collide with
 * any future kanji/grammar scheduler built on the same engine.
 */
(function (global) {
  'use strict';
  ...
  var STORAGE_KEY = 'eznihongo_vocab_fsrs_v1';
