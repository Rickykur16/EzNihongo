...
- Pagination per 50 item, hingga offset 10.000. Filter status di UI berlaku pada halaman yang sedang dimuat, bukan seluruh database. Ini batas MVP yang perlu dipertimbangkan sebelum volume besar.
