...
-- 欲・予定 belum diajarkan, jadi contoh menulis ほしい dan よてい dengan kana.
--
...
DECLARE
  ...
  v_pola JSONB := $json$[
  {
    ...
    "example": "日本へ 行きたいです。",
    "notes": "Batang kata kerja bentuk ます + たいです. Objeknya boleh ditandai を atau が (みずを のみたい／みずが のみたい). たい berkonjugasi seperti kata sifat い: たかったです、たくないです. HANYA untuk keinginan diri sendiri atau pertanyaan ke lawan bicara — keinginan orang ketiga memakai 〜たがっています.",
    "examples": [
      {
        "jp": "日本へ 行きたいです。",
        "hl": "行きたいです",
      ...
      },
      {
        "jp": "つめたい みずが 飲みたいです。",
        "hl": "飲みたいです",
        "id": "Saya ingin minum air dingin."
      },
      {
        "jp": "山に のぼりたいです。",
        "hl": "のぼりたいです",
        "id": "Saya ingin mendaki gunung."
      }
    ]
  },
  {
    ...
    "pattern": "〜たくないです",
    "meaning": "tidak ingin ~",
    "example": "きょうは どこへも 行きたくないです。",
    "notes": "Karena たい berperilaku seperti kata sifat い, bentuk negatifnya buang い ganti くないです. Lampau negatifnya 〜たくなかったです. Bentuk sopan lain yang sama artinya: 〜たくありません.",
    "examples": [
      {
        "jp": "きょうは どこへも 行きたくないです。",
        "hl": "行きたくないです",
        "id": "Hari ini saya tidak ingin pergi ke mana pun."
      },
      {
        "jp": "雨の 日は 出かけたくないです。",
        "hl": "出かけたくないです",
        "id": "Di hari hujan saya tidak ingin keluar."
      },
      {
        "jp": "まだ かえりたくないです。",
        "hl": "かえりたくないです",
        "id": "Saya belum ingin pulang."
      }
    ]
  },
  {
    ...
    "examples": [
      {
        "jp": "新しい かばんが ほしいです。",
        "hl": "ほしいです",
        "id": "Saya ingin tas baru."
      },
      {
        "jp": "もっと じかんが ほしいです。",
        "hl": "ほしいです",
        "id": "Saya ingin waktu lebih banyak."
      },
      {
        "jp": "大きい 車が ほしいです。",
        "hl": "ほしいです",
        "id": "Saya ingin mobil besar."
      }
    ]
  },
  {
    ...
    "example": "らいねん 日本へ 行くつもりです。",
    "notes": "Bentuk KAMUS + つもりです menyatakan niat pribadi yang sudah dipikirkan matang. Bentuk negatifnya [bentuk ない] + つもりです (行かないつもりです). Lebih personal daripada よてい yang menyatakan jadwal yang sudah ditetapkan.",
    "examples": [
      {
        "jp": "らいねん 日本へ 行くつもりです。",
        "hl": "つもりです",
      ...
      {
        "jp": "なつやすみは 山へ 行くつもりです。",
        "hl": "つもりです",
        "id": "Liburan musim panas saya berniat pergi ke gunung."
      },
      {
        "jp": "きょうは 出かけないつもりです。",
        "hl": "つもりです",
        "id": "Hari ini saya berniat tidak keluar."
      }
    ]
  },
  {
    "lesson": 2,
    "pattern": "〜予定です",
    "meaning": "dijadwalkan / sudah direncanakan ~",
    "example": "三月に 国へ かえるよていです。",
    "notes": "よてい menyatakan JADWAL yang sudah ditetapkan (rapat, keberangkatan, acara), bukan sekadar niat. Karena itu boleh dipakai untuk orang lain, berbeda dari つもり yang hanya untuk niat diri sendiri. Polanya [bentuk kamus／kata benda の] + よていです.",
    "examples": [
      {
        "jp": "三月に 国へ かえるよていです。",
        "hl": "よていです",
        "id": "Bulan Maret saya dijadwalkan pulang ke negara asal."
      },
      {
        "jp": "あした 先生と 会うよていです。",
        "hl": "よていです",
        "id": "Besok saya dijadwalkan bertemu guru."
      },
      {
        "jp": "らいしゅう しけんの よていです。",
        "hl": "よていです",
        "id": "Minggu depan ada jadwal ujian."
      }
    ]
  },
  {
    "lesson": 2,
    "pattern": "〜ましょう／ませんか",
    "meaning": "mari ~ / maukah ~ (ajakan)",
    "example": "いっしょに 行きましょう。",
    "notes": "〜ませんか MENGAJAK dengan halus karena menanyakan kesediaan; 〜ましょう mengajak lebih tegas atau dipakai untuk menyetujui ajakan. Alur percakapan yang lazim: A mengajak dengan ませんか, lalu B menyetujui dengan ましょう.",
    "examples": [
      {
        "jp": "いっしょに ひるごはんを 食べませんか。",
        "hl": "食べませんか",
        "id": "Maukah makan siang bersama?"
      },
      {
        "jp": "はい、食べましょう。",
        "hl": "食べましょう",
...
BEGIN
  ...
  IF v_module_id IS NULL THEN
    RAISE NOTICE '088: modul Bab % di kursus % tidak ditemukan — skip Tata Bahasa.', v_bab_no, v_course_slug;
    RETURN;
  END IF;

  IF v_module_title !~* v_title_re THEN
    RAISE NOTICE '088: modul Bab % terbaca "%" — kalau ternyata bukan bab yang dimaksud, pindahkan pelajarannya lewat admin (tidak perlu migrasi baru).',
      v_bab_no, v_module_title;
  END IF;

  RAISE NOTICE '088: seed 2 pelajaran Tata Bahasa Bab % ke modul "%".', v_bab_no, v_module_title;
  ...
  IF EXISTS (
    ...
    RAISE NOTICE '088: modul "%" sudah punya pelajaran bertipe text lain (%) — cek duplikasi materi Tata Bahasa lewat admin.',
      v_module_title,
  ...
  IF v_other < 3 THEN
    RAISE NOTICE '088: modul "%" cuma punya % lesson lain (< 3) — urutan 4 dan 6 tidak bisa dibentuk, kedua pelajaran ditaruh di akhir modul. Geser manual lewat admin kalau perlu.',
  ...
  IF (SELECT COUNT(*) FROM module_grammar WHERE lesson_id = v_l1) <> v_n_l1
    ...
    RAISE EXCEPTION '088: jumlah pola harus % dan % (dapat % dan %)',
      v_n_l1, v_n_l2,
  ...
  IF EXISTS (
    ...
    RAISE EXCEPTION '088: ada pola dengan < 2 contoh kalimat atau contoh tanpa terjemahan';
  END IF;

  -- Pagar level: contoh kalimat hanya boleh memakai kanji yang sudah
  -- diajarkan sampai Bab 19 (lihat v_kanji_ok).
  IF EXISTS (
    ...
    RAISE EXCEPTION '088: ada kanji di luar daftar taught (s/d Bab %) pada contoh kalimat', v_bab_no;
  END IF;
  ...
  IF v_other >= 3 THEN
    ...
    IF v_pos1 <> 4 OR v_pos2 <> 6 THEN
      RAISE EXCEPTION '088: sort_order final pelajaran bukan 4 dan 6 (dapat % dan %)', v_pos1, v_pos2;
    END IF;
    ...
    IF EXISTS (
      ...
      RAISE EXCEPTION '088: ada sort_order kembar di modul setelah penomoran ulang';
    END IF;

    RAISE NOTICE '088: selesai — "%" di sort_order 4, "%" di sort_order 6, % pola / % contoh (slot 5 & 7 untuk Tugas Bunpou: % terisi).',
  ...
  ELSE
    RAISE NOTICE '088: selesai — % pola ter-wire, posisi menyusul diatur manual.', v_n_l1 + v_n_l2;
  END IF;
END $mig$;
