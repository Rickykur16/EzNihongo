...
import learningStateRouter from './routes/learning-state.js';
import kanjiAuthRouter from './routes/kanji-auth.js';
import ttsRouter from './routes/tts.js';
import { grammarDialoguePublicRouter } from './routes/grammar-dialogue.js';
...
app.use('/api/grammar-dialogues', grammarDialoguePublicRouter);
